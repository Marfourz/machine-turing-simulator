  ...
  <div class="h-screen w-screen space-y-10">
    ...
    <div class="flex px-10">
      <div class="w-1/2 space-y-20">
        ...
        <States :states="actionsKeys" :currentState="currentState" class="w-1/2"></States>
        ...
        <div class="space-x-4">
          ...
          <button
            ...
            :class="{'bg-green-300 cursor-not-allowed': !canLoadTuringMachine}"
            :disabled="!canLoadTuringMachine"
          >
      ...
      <div class="w-1/2 space-y-6">
        <table class="w-full table-auto">
          ...
          <tbody>
            <template v-for="state in actionsKeys">
              <tr class="bg-white border-b" v-for="(readValue, i) in values"  v-if="state != 'end'">
                <td
                  rowspan="3"
                  scope="row"
                ...
                <td>
                  <div class="flex justify-center">
                    ...
                    id=""
                    @change="
                      onMoveChange($event, state, readValue as WriteAndReadType)
                    "
                  >
                    <option value="">Aucun</option>
                ...
                <td>
                  <div class="flex justify-center">
                    ...
                    "
                  >
                    <option :value="s"  v-for="s in actionsKeys">{{s}}</option>
        ...
        <div class="flex  flex-col items-end space-y-4">
          ...
          <div class="border rounded">
            <input type="text" v-model="newState" name="" id="" class="py-2 px-4 bg-gray-50">
          </div>
          </div>
...
const actions = reactive<ActionList>({
  q0: {} as any,
  end:{} as any
});
...
async function turingMachine() {
  ...
  while (currentState.value != endState) {
   ...
   /* @ts-ignore */ 
    ...
    if (action) {
      if (action.write != null && action.write != "") ruban.value[position.value] = action.write;
      if (action.moveTo != null && action.moveTo != "") position.value += +action.moveTo;
